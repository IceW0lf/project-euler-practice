...
public class ID017 {
    ...
    public static void main(String[] args) {
        System.out.println(calcLetterCountOfNumbers(5));
        System.out.println(calcLetterCountOfNumbers(1000));
    }

    public static Integer calcLetterCountOfNumbers(Integer max) {
        Integer sum = 0;
    ...
    private static String numberToString(Integer number) {
        if (number < 20) {
            ...
            throw new IllegalArgumentException("enter number equal or less than 1000");
        }
    }
